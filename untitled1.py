...
#dll imports
everything_dll = ctypes.WinDLL ("F://DOWNLOAD//Everything-SDK//dll//Everything64.dll")
...
#show the number of results
    if num_results == 0:
        #print(filename,"Result Count: {}".format(num_results))
        count_0.append(filename)
...
with open('not_in_disk.txt', 'w', encoding='utf-8') as file:
    for name in count_0:
        file.write(f"{name}\n")
#show results
